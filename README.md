...
[Detect.py] is the main file in this project. 

Real-time road-object detection using a YOLO model over a live camera feed, combined with a
yellow road-line tracer and an optional 3D visualization of detected objects relative to the
camera.
...
The selected YOLO model is loaded on [Detect.py:12]
